...
/**
 * A collection of supported schematic formats.
 */
public interface SchematicFormat {
     ...
     */
    SchematicReader getReader(InputStream inputStream) throws IOException;
     ...
     * @throws IOException thrown on I/O error
     */
    SchematicWriter getWriter(OutputStream outputStream) throws IOException;
