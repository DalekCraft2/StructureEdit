// Just in case I need this in the future for whatever reason, I'll keep it here for exactly one commit before removing it.
//
...
//
// public class SchematicRenderer extends MouseAdapter implements GLEventListener, KeyListener {
...
//    public boolean shouldReloadTextures = true;
...
//            // Rotate the camera
//            double dTheta = Math.toRadians(mousePoint.getX() - e.getX()) * ROTATION_SENSITIVITY;
//            double dPhi = Math.toRadians(mousePoint.getY() - e.getY()) * ROTATION_SENSITIVITY;
//            camera.rotate(dTheta, dPhi);
//        } else if (SwingUtilities.isRightMouseButton(e)) {
//            // TODO Make the camera drag translation more accurate.
//            // Translate the camera
//            double dx = -(mousePoint.getX() - e.getX()) * TRANSLATION_SENSITIVITY;
//            double dy = (mousePoint.getY() - e.getY()) * TRANSLATION_SENSITIVITY;
//            // camera.pan(mousePoint.getX(), mousePoint.getY(), e.getX(), e.getY());
//            camera.pan(dx, dy);
//        }
//        mousePoint = e.getPoint();
//    }
...
//        public void pan(/*double mouseX, double mouseY, double newMouseX, double newMouseY*/ double dx, double dy) {
//            panX += dx;
//            panY += dy;
