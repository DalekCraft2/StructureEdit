...
public class AutoCompletion extends PlainDocument {
    ...
    private boolean startsWithIgnoreCase(@NotNull String str1, @NotNull String str2) {
        return str1.toUpperCase(Locale.ROOT).startsWith(str2.toUpperCase(Locale.ROOT));
    }
}
